...
|----|-------------------|-----------|--------|
| H-1 | Monotonic z-score decrease | Each pass reduces z | PENDING |
| H-2 | 3-5 passes removes watermark | detection < 50% by pass 5 | PENDING |
| H-3 | Higher delta = more robust | delta 4.0 survives more than 1.0 | PENDING |
| H-4 | Short texts more vulnerable | 50w loses faster than 500w | PENDING |
| H-5 | FPR ≤ 5% | Unwatermarked text not flagged | PENDING |
| H-6 | Survival is predictable (R² > 0.5) | Model from pass+delta+length | PENDING |
